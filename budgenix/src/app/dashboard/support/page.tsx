  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-800">Centrum wsparcia</h1>
        <p className="text-sm sm:text-base text-gray-500 mt-1">Uzyskaj pomoc od naszego asystenta AI lub skontaktuj się z zespołem wsparcia</p>
      </div>
