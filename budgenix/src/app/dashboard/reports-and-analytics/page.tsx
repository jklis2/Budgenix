    ...
    <div id="reports-container" className="space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h2 className="text-lg font-semibold text-gray-800">Porady finansowe</h2>
          ...
          {financialInsights.length > 0 && (
            <span className="px-3 py-1 bg-indigo-100 text-indigo-700 text-sm font-medium rounded-full">
              {financialInsights.length} {financialInsights.length === 1 ? 'porada' : financialInsights.length >= 2 && financialInsights.length <= 4 ? 'porady' : 'porad'}
            </span>
          )}
        </div>
