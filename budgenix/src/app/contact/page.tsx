            ...
            <div>
              ...
              <form className="space-y-6">
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full px-6 py-3 bg-gradient-to-r from-indigo-600 to-indigo-700 text-white font-medium rounded-lg shadow-sm hover:from-indigo-700 hover:to-indigo-800 transition-all"
                  >
                    Wyślij wiadomość
                  </button>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="pt-6">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center hover:bg-indigo-100 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-10">
            <p className="text-gray-600">
              ...
              <Link href="#" className="text-indigo-600 font-medium ml-1 hover:text-indigo-700">
