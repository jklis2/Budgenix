    ...
    <HomeLayout>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="mt-10 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                <Link href="/auth/register" className="px-8 py-3 bg-white text-teal-700 font-medium rounded-lg shadow-md hover:bg-teal-50 transition-colors text-center">
                  Rozpocznij za darmo
                </Link>
                <Link href="/about" className="px-8 py-3 border border-white text-white font-medium rounded-lg hover:bg-white/10 transition-colors text-center">
                  Dowiedz się więcej
                </Link>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="relative w-full max-w-md h-80">
                ...
                <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden h-full flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32 text-teal-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-indigo-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10">
            <Link href="/auth/register" className="px-8 py-3 bg-white text-indigo-700 font-medium rounded-lg shadow-md hover:bg-indigo-50 transition-colors inline-block">
              Rozpocznij za darmo
            </Link>
          </div>
        </div>
