export function renderResetPasswordEmail({ resetUrl }: { resetUrl: string }): string {
  return `<!DOCTYPE html>
<html lang="pl">
<head>
  <meta charSet="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Reset hasła | Budgenix</title>
  <style>
    body {
      margin: 0;
      padding: 0;
  ...
  <div class="wrapper">
    <div class="container">
      <div class="header">
        ...
        <div class="eyebrow">RESET HASŁA</div>
      </div>

      <div class="content">
        <h1>Reset hasła do konta</h1>
        <p class="subtitle">
          Otrzymaliśmy prośbę o zresetowanie hasła do Twojego konta w Budgenix.
          Aby ustawić nowe hasło, kliknij w poniższy przycisk.
        </p>

        <div class="info-box">
          Ze względów bezpieczeństwa link do resetu hasła jest ważny 15 minut. 
      ...
      <div class="footer">
        ...
        hasło nie zostanie zmienione bez kliknięcia w link.<br /><br />
